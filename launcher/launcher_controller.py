...
FILES_TO_DOWNLOAD = [
    (
        f"{GITHUB_RAW_CONTENT_URL}/{OCTOBOT_GITHUB_REPOSITORY}/{OCTOBOT_VERSION_RELEASE_PHASE}/{DEFAULT_CONFIG_FILE}",
        CONFIG_FILE
    ),
    (
        f"{GITHUB_RAW_CONTENT_URL}/{OCTOBOT_GITHUB_REPOSITORY}/{OCTOBOT_VERSION_RELEASE_PHASE}/{CONFIG_DEFAULT_EVALUATOR_FILE}",
...
GITHUB_LATEST_BOT_RELEASE_URL = f"{GITHUB_API_CONTENT_URL}/repos/{OCTOBOT_BINARY_GITHUB_REPOSITORY}/releases/latest"
