...
from launcher import CONFIG_FILE, OCTOBOT_GITHUB_REPOSITORY, \
    ...
    TENTACLES_PATH, inc_progress, FORCE_BINARY, CONFIG_FILE_SCHEMA_NAME, CONFIG_FILE_SCHEMA_WITH_PATH
...
FILES_TO_DOWNLOAD = [
    ...
    (
        f"{GITHUB_RAW_CONTENT_URL}/{OCTOBOT_GITHUB_REPOSITORY}/{OCTOBOT_REFERENCE_BRANCH}/{CONFIG_FILE_SCHEMA_NAME}",
